...
<script>
    export default {
        ...
        if (value.length < 3) {
          ...
          this.$axios.post('http://124.71.159.25:8000/api/register?select=1', formData)
            .then(response => {
        ...
        this.$refs.addFormRef.validate((valid) => {
          if (valid) {
            ...
            // 成功.
            this.$axios.post('http://124.71.159.25:8000/api/register', formData
            )
              .then(response => {
        ...
        this.$refs[Dataset].validate((valid) => {
          if (valid) {
            // 成功
            this.$axios.post("http://124.71.159.25:8000/api/login", {
